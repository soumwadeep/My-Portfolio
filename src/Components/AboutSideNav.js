    ...
    <>
       <div className="col-sm-4">
        ...
        <ul className="nav nav-pills flex-column">
          ...
          <li className="nav-item">
            <a className="btn btn-success" href="https://docs.google.com/document/d/e/2PACX-1vSCLwqNW9kaMUIgSigpW7sLJCyOx0iWIAC6OLKKYAONkejfWCL2xM11JNr2AKS8y0tP3U50mhRE6jGG/pub"target="_blank" rel="noreferrer"><i className="fa fa-file-text" aria-hidden="true"></i>My Resume</a>
          </li>
        </ul>
