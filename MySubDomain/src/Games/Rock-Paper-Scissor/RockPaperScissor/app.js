...
const game = () => {
  ...
  const winner = (player, computer) => {
    ...
    if (player === computer) {
      result.textContent = "Computer Also Chose The Same.So, It's A Tie.";
    } else if (player == "rock") {
      if (computer == "paper") {
        result.textContent = "Computer Chose Paper.So,Computer Won!";
        computerScore++;
      ...
      if (computer == "rock") {
        result.textContent = "Computer Chose Rock.So,Computer Won!";
        computerScore++;
        computerScoreBoard.textContent = computerScore;
      } else {
      ...
      if (computer == "scissors") {
        result.textContent = "Computer Chose Scissors.So,Computer Won!";
        computerScore++;
        computerScoreBoard.textContent = computerScore;
      } else {
